    ...
    <div className="max-w-sm relative bg-[#1A1A1A] rounded-lg shadow">
      <section className="relative">
        <Link to={`/product/${p._id}`}>
          <span
            className="absolute bottom-3 right-3 bg-pink-900 
          text-pink-300 text-sm font-medium mr-2 px-2.5 py-0.5 rounded-full"
          >
            {p.brand}
          </span>
          <img
      ...
      <div className="flex justify-between">
        ...
        <p className="text-block font-semi-bold text-pink-500">
      ...
      <section className="flex justify-between items-center">
        <Link
          ...
          font-medium text-center text-white bg-pink-700 rounded-lg 
          hover:bg-pink-800 focus:ring-4 focus:outline-none 
